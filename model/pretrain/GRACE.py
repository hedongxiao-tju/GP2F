...
class Model(torch.nn.Module):
    def __init__(self, gnn, num_hidden: int, num_proj_hidden: int,
                 tau: float = 0.5):
    ...
    def forward(self, x: torch.Tensor,
        ...
        return self.gnn.forward_weighted(x, edge_index, edge_weight)

    def embed(self, x: torch.Tensor,
                edge_index: torch.Tensor, edge_weight: torch.Tensor) -> torch.Tensor:
        # z = self.encoder(x, edge_index, edge_weight)
        z = self.gnn.forward_weighted(x, edge_index, edge_weight)
        return z.detach()
